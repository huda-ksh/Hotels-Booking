...
function fillInAddress_textarea() {
    ...
    $('#selectedCity').val(place.address_components[0].long_name);
    $('#hdnCity').val(place.address_components[0].long_name);
    $('#hdnCountry').val(place.address_components[3].long_name);
    $('#hdnPlace_id').val(place.place_id);
